...
public  class  Alunos {
	...
	public  void  imprirDados () {
		Sistema . para fora . println ( " ID: " + id + " \ n Nome: " + nome + " \ n Idade: " + idade + " \ n RA: " + ra);
	}
	
	pública  vazio  inserir ( Connection  conn )
	{
		...
		try ( PreparedStatement stm = conn . prepareStatement (sqlInsert)) {
			...
			tentar
			{
				...
				Sistema . para fora . imprimir (e1 . getStackTrace ());
			}
		}
	}
	...
	pública  vazio  atualizar ( Connection  conn )
	{
